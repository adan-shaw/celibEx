...
int main (int argc, char *args[])
{
	...
	printf ("length: %d, size: %d, threshold: %d\n", cel_hashmap_length (map), cel_hashmap_size (map), cel_hashmap_threshold (map));
	putchar ('\n');
	...
	//test set
	printf ("+---test set: \n");
	printf ("set(%15s, %15s): %15s\n", "chenmanwen", "father", (char *) cel_hashmap_set (map, "chenmanwen", "father"));
	printf ("set(%15s, %15s): %15s\n", "yangqinghua", "mother", (char *) cel_hashmap_set (map, "yangqinghua", "mother"));
	putchar ('\n');
